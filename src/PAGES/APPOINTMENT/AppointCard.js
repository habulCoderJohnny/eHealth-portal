    ...
    return (
        <div className="card lg:max-w-lg shadow-xl my-5">
            <div className="card-body text-center">
                ...
                <p> <span className='stat-value text-gray-500'>{slots.length}</span> {slots.length > 1 ? 'Spaces ' : 'Space'} available</p>
                <p className='stat-title'>Fee : <span className='stat-value text-primary'>${price}</span></p>
